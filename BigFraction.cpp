...
void BigFraction::reverse() const { high.swap(low); }
...
std::string BigFraction::high_part() const { return high.to_string(); }

std::string BigFraction::low_part() const { return low.to_string(); }
